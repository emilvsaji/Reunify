...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    if ($_POST['action'] === 'add_response') {
        ...
        if (empty($response_text) || empty($status)) {
            ...
            $query = "UPDATE feedback SET admin_response = ?, status = ?, reviewed_by = ? WHERE feedback_id = ?";
...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="navbar-menu">
                ...
                <a href="manage_claims.php"><i class="fas fa-tasks"></i> Claims</a>
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <p>Review and analyze feedback from students to improve the system.</p>
        </div>
