...
<div class="feedback-details">
    ...
    <?php if ($_SESSION['user_role'] === 'admin' && $feedback['admin_response']): ?>
        <div class="detail-section">
            <h3 style="margin-bottom: 1rem; color: var(--success);"><i class="fas fa-check-circle"></i> Admin Response</h3>
            <div class="detail-row">
                <div class="detail-label">Reviewed By</div>
                <div class="detail-value"><?php echo htmlspecialchars($feedback['reviewed_by'] ?? 'Admin'); ?></div>
            </div>
            <div style="margin-bottom: 1rem;">
    ...
    <?php if ($_SESSION['user_role'] === 'faculty' && $feedback['faculty_response']): ?>
        <div class="detail-section">
            <h3 style="margin-bottom: 1rem; color: var(--success);"><i class="fas fa-check-circle"></i> Faculty Response</h3>
            <div class="detail-row">
                <div class="detail-label">Reviewed By</div>
                <div class="detail-value"><?php echo htmlspecialchars($feedback['reviewed_by'] ?? 'Faculty'); ?></div>
            </div>
            <div style="margin-bottom: 1rem;">
                <div class="detail-label" style="margin-bottom: 0.5rem;">Response</div>
                <div class="response-box">
    ...
    <div class="detail-section">
        ...
        <form onsubmit="return handleResponseSubmit(event, <?php echo $feedback['feedback_id']; ?>);">
            ...
            <div class="form-group">
                ...
                <textarea id="responseText" placeholder="Write your response to this feedback..." required></textarea>
            </div>
