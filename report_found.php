...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && verifyCSRFToken($_POST['csrf_token'] ?? '')) {
    ...
    $time_found = sanitize($_POST['time_found'] ?? '');
    $contact_info = sanitize($_POST['contact_info'] ?? '');
    $is_equipment = isset($_POST['is_equipment']) ? 1 : 0;
    $department_id = !empty($_POST['department_id']) ? intval($_POST['department_id']) : null;
    
    // Validation
    if (empty($title) || empty($description) || empty($category_id) || empty($location) || empty($date_found)) {
        ...
        if (empty($error)) {
            ...
            $stmt->bind_param("ssisssiisii", $title, $description, $category_id, $location, 
                            $date_found, $time_found, $_SESSION['user_id'], $contact_info, 
            ...
            if ($stmt->execute()) {
                ...
                // Create notification
                createNotification($_SESSION['user_id'], 'item_approved', 'Found Item Reported', 
                                 "Your found item report '$title' has been submitted successfully", $item_id);
                
                setSuccessMessage('Found item reported successfully! Thank you for your help.');
...
<head>
    ...
    <title>Report Found Item - <?php echo APP_NAME; ?></title>
...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="navbar-menu">
                ...
                <li><a href="report_found.php" class="active"><i class="fas fa-check-circle"></i> Report Found</a></li>
    ...
    <div class="dashboard-container">
        <div class="dashboard-header">
            <h1><i class="fas fa-check-circle"></i> Report Found Item</h1>
            <p>Found something? Help return it to its owner by reporting it here.</p>
        </div>
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" required 
                              placeholder="Describe the found item in detail (color, brand, contents, unique features, etc.)"><?php echo htmlspecialchars($description ?? ''); ?></textarea>
                </div>

                <div class="form-row">
                    <div class="form-group">
                        <label for="location">
                            <i class="fas fa-map-marker-alt"></i> Found Location *
                        </label>
                        <input type="text" id="location" name="location" required 
                               placeholder="e.g., Main Building Corridor, Sports Ground" 
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="time_found">
                            <i class="fas fa-clock"></i> Approximate Time Found
                        </label>
                        <input type="time" id="time_found" name="time_found" 
                               value="<?php echo htmlspecialchars($time_found ?? ''); ?>">
                    </div>

                    <div class="form-group">
                        <label for="contact_info">
                            <i class="fas fa-phone"></i> Your Contact Information *
                        </label>
                ...
                <div class="form-group">
                    <label for="item_image">
                        <i class="fas fa-image"></i> Upload Item Image (Recommended)
                    </label>
                ...
                <div class="alert alert-success">
                    ...
                    <div>
                        ...
                        <ul style="margin-top: 0.5rem; margin-left: 1.5rem;">
                            <li>Your report helps owners find their lost items</li>
                            <li>Provide accurate details to ensure proper identification</li>
                            <li>Upload a clear photo to help owners recognize their item</li>
                ...
                <div style="display: flex; gap: 1rem;">
                    <button type="submit" class="btn btn-secondary">
                        <i class="fas fa-paper-plane"></i> Submit Found Item Report
                    </button>
