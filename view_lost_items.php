...
<head>
    ...
    <title>Lost Items - <?php echo APP_NAME; ?></title>
...
<body>
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="navbar-menu">
                ...
                <li><a href="view_lost_items.php" class="active"><i class="fas fa-heart-broken"></i> Lost Items</a></li>
    ...
    <div class="dashboard-container">
        <div class="dashboard-header">
            <h1><i class="fas fa-heart-broken"></i> Lost Items</h1>
            <p>Browse through reported lost items. If you find your item, you can claim it.</p>
        </div>
        ...
        <div class="search-filter-section">
            <form method="GET" action="">
                <div class="search-bar">
                    ...
                    <input type="text" name="search" placeholder="Search by title, description, or location..." 
                ...
                <?php while($item = $items->fetch_assoc()): ?>
                    <div class="item-card">
                        ...
                        <div class="item-content">
                            <span class="item-badge lost">
                                <i class="fas fa-heart-broken"></i> LOST
                            </span>
